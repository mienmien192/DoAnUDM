            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="header__cart">
                        <ul>
                            <li><a href="#"><i class="fa fa-heart"></i> <span>1</span></a></li>
                            <li><a href="<?php echo URL.'cart/index' ?>"><i class="fa fa-shopping-bag"></i> 
                                <span>
                                    ...
                                    <td class="shoping__cart__quantity">
                                        <div class="quantity">
                                            <div class="pro-qty">
                                                ...
                                                <input type="text" value="<?php echo $value['count']; ?>" data-id="<?php echo $value['id']; ?>">
    ...
    <script type="text/javascript">
        $('a.removeCart').click(function(event){
            ...
            $.ajax({
                ...
                success:function(){
                    $(name).empy();
                    $("#total_Cart").load("http:http://localhost:8080/codePHP/DOAN/cart/index #total_Cart");
                }
            });
        });
        $("span.qtybtn").click(function(){
            var id = $(this).siblings('input').attr("data-id");
            var href="http://localhost:8080/codePHP/DOAN/cart/update/"+id;
